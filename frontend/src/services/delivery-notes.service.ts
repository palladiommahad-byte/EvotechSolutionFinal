...
export interface DeliveryNote {
  ...
  /** Bon de commande client reference */
  client_po_number: string | null;
  /** Added by migration 016: tracks whether this BL has been invoiced */
  billing_status: 'not_invoiced' | 'invoiced';
  /** Added by migration 016: UUID of the invoice that covers this BL, if any */
  invoice_id: string | null;
  /** Added by migration 016: whether 20% TVA applies to this BL */
  tax_enabled: boolean;
  created_at: string;
  updated_at: string;
}
