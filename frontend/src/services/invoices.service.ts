...
export const invoicesService = {
  ...
  /**
   * Create a single invoice from one or multiple BLs (grouped invoicing).
   * Backend validates client consistency, billing status, and tax mode,
   * then generates a safe unique invoice number via row-locked sequence.
   */
